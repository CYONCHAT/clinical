...
class ValidationError extends AppError {
  constructor(message = 'Dados inválidos', code = 'VALIDATION_ERROR', details = undefined) {
...
module.exports = { AppError, AuthenticationError, AuthorizationError, ForbiddenError, ValidationError, NotFoundError, toErrorResponse };
