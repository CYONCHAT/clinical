...
const host = process.env.HOST || process.env.CLINICAL_HOST || '0.0.0.0';
const port = Number(process.env.PORT || process.env.CLINICAL_PORT || 4710);
...
const jwtSecret = requiredInProduction('JWT_SECRET', isTest ? 'clinical-test-secret-change-me' : 'clinical-development-secret-change-me');
...
module.exports = {
  ...
  database: {
    ...
    name: process.env.DB_NAME || 'operaon_clinical',
  ...
  mfaEncryptionKey: process.env.MFA_ENCRYPTION_KEY || (isTest ? 'clinical-test-mfa-key-change-me-32' : 'clinical-development-mfa-key-change-me-32'),
  email: {
