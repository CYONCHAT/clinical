# Contrato do módulo — clinical

Este documento resume o contrato local de clinical. O contrato transversal de headers e webhooks está em [communication-contract.md](communication-contract.md).
